...
import { IMAGE } from '../../../../../../configs/lang';
import { DrawerSettings } from '../../../../../DrawerSettings';
import { ImageBlock } from '../../../../pageSlice';
import { BlockEditMenu, BlockEditMenuProps } from '../BlockEditMenu';
import { PageImageForm } from '../PageImageEditor/PageImageForm';

export interface ImageEditorProps extends Omit<BlockEditMenuProps, 'onSettings'> {
  showImageWideWidthCheck?: boolean;
  block: ImageBlock;
  imageUpload: React.ReactNode;
  onBlockChanged: (values: ImageBlock) => void;
}
    ...
    <div className="page-editor-block">
      ...
      >
        <Form layout="vertical">
          <Form.Item label={IMAGE}>{imageUpload}</Form.Item>
        </Form>

        <PageImageForm
          form={form}
          block={block}
          showWideWidthCheck={showImageWideWidthCheck}
          onSubmit={(values) => {
      ...
      <Card>
        <Image
          style={{ maxWidth: block.width || 350, maxHeight: block.height || 200 }}
          preview={false}
          src={block.src}
